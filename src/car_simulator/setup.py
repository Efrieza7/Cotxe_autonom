...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/meshes', ['meshes/gt3_body.stl', 'meshes/gt3_cabin.stl', 'meshes/cone.stl']),
        ('share/' + package_name + '/rviz', ['rviz/car_simulator.rviz']),
        ('share/' + package_name + '/maps', ['maps/sample_track.yaml', 'maps/complex_track.yaml', 'maps/complex_track_clean.yaml', 'maps/circuit_realista.yaml', 'maps/circuit_realista_V2.yaml', 'maps/circuit_BCN.yaml', 'maps/circuit_realista_35.yaml']),
    ],
